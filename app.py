...
def review():
    ...
    # exemplo : Positivo , ./static/assets/emoticons/positive.png
        ...
        textosentimento , imagem = sa.predict(review)

        return jsonify({'status':'success' , 'prediction':'textosentimento', 'url' : 'imagem'})
